...
const pillars = [
  {
    ...
    desc: "A IA encontra empresas que precisam de um app — nichos onde você cobra R$ 2K a R$ 10K por projeto.",
  },
  {
    icon: Rocket,
    num: "02",
    title: "Crie o App em Minutos",
    desc: "Sem código. A IA gera apps profissionais que parecem ter custado R$ 50 mil para desenvolver.",
  },
  {
    icon: MessageSquare,
    num: "03",
    title: "Feche Clientes no Automático",
    desc: "Mensagens de venda prontas e testadas. O cliente lê e precisa responder.",
  },
];
      ...
      <div className="container max-w-5xl mx-auto text-center">
        <AnimatedSection>
          ...
          <p className="text-muted-foreground text-base md:text-lg mb-10 md:mb-12 max-w-2xl mx-auto">
            O Leadfy é a única plataforma no Brasil que te leva do zero ao primeiro cliente pagante — combinando IA, prospecção e vendas em um único lugar.
          </p>
        </AnimatedSection>
          ...
          {pillars.map((p, i) => (
            <AnimatedSection key={i} delay={i * 100}>
              <div className="glass-card p-6 md:p-8 text-center hover-card-glow hover-inner-glow group h-full relative overflow-hidden">
                ...
                <div className="w-12 h-12 md:w-14 md:h-14 rounded-2xl bg-primary/10 flex items-center justify-center mx-auto mb-5 group-hover:bg-primary/20 group-hover:shadow-[0_0_20px_hsl(199_75%_48%/0.25)] transition-all duration-300">
